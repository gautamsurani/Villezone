...
public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.ViewHolder> {
    private List<Sub_category> listdata;
    private ItemClickListener<Sub_category> itemClickListener;
    ...
    public void setItemClickListener(ItemClickListener<Sub_category> itemClickListener) {
        this.itemClickListener = itemClickListener;
    }

    public void setData(List<Sub_category> listdata) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final Sub_category myListData = listdata.get(position);
